...
label prologue:
    ...
    scene bg_elara_apartment with fade
    ...
    label introduction_to_zephyr:
        scene bg_veil_vision with fade
...
label act_i:
    ...
    # First Veil Vision
    scene bg_veil_vision with fade
    e "There it is again! That shimmering... it’s calling to me. What is this?"
...
label fight_back_with_thorne:
    ...
    scene bg_covenant_stronghold with fade
